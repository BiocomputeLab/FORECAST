...
plt.plot(D,Cost_8(D)[0],linewidth=2,label='Sorting in 8 bins')
plt.plot(D,Cost_16(D)[0],linewidth=2,label='Sorting in 16 bins')
plt.yscale('log')
plt.xscale('log')
...
fig.savefig('cost.pdf', transparent=True)
# plt.close('all')
